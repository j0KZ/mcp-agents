 ...
 */
export function generateFindingId(filePath, line, type) {
    const hash = crypto
        .createHash('sha256')
 ...
 */
export function extractCodeContext(content, lineNumber) {
 ...
 */
export function shouldScanFile(filePath, excludePatterns) {
