...
const patternsData = JSON.parse(readFileSync(join(__dirname, '../patterns/sql-patterns.json'), 'utf-8'));
const SQL_INJECTION_PATTERNS = patternsData.patterns.map((p) => ({
...
//# sourceMappingURL=sql-injection-scanner.js.map