    ...
    findFixes(context) {
        ...
        traverse(context.ast, {
            CallExpression: (path) => {
                ...
                fixes.push(this.createFix('console-log', 'Remove console statement', line, column, oldCode, '', // Remove the line
                CONFIDENCE.HIGH, true, 'medium'));
            },
        });
        return fixes;
    }
}
//# sourceMappingURL=console-log-fixer.js.map