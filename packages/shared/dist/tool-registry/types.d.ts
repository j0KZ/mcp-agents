 ...
 */
export type ToolCategory = 'analysis' | 'generation' | 'refactoring' | 'design' | 'security' | 'orchestration' | 'documentation';
/**
 * MCP server names in the @j0kz ecosystem
 */
export type MCPServerName = 'smart-reviewer' | 'test-generator' | 'architecture-analyzer' | 'security-scanner' | 'refactor-assistant' | 'api-designer' | 'db-schema' | 'doc-generator' | 'orchestrator';
/**
