 ...
 */
export function getToolsByFrequency(frequency) {
    return TOOL_REGISTRY.filter(t => t.frequency === frequency);
}
/**
 * Get tools filtered by server
 */
export function getToolsByServer(server) {
 ...
 */
export function getExplicitlyDeferredTools() {
