 ...
 */
export const TOOL_NAME_MAPPINGS: Record<string, ToolNameMapping> = {
  // Smart Reviewer Tools
  'review_file': {
    canonical: 'review_file',
    aliases: [
      // English
      'review_file', 'review', 'reviewfile', 'check_file', 'checkfile', 'analyze_file', 'analyzefile',
      // Spanish
      'revisar_archivo', 'revisar', 'revisararchivo', 'analizar_archivo', 'analizararchivo',
      'verificar_archivo', 'verificararchivo', 'chequear_archivo', 'chequeararchivo'
    ],
    description: {
  ...
  'batch_review': {
    ...
    aliases: [
      'batch_review', 'review_multiple', 'reviewmultiple',
      'revisar_varios', 'revisarvarios', 'revisar_multiples', 'revisarmultiples'
    ],
    description: {
  ...
  'generate_auto_fixes': {
    ...
    aliases: [
      'generate_auto_fixes', 'autofix', 'autofixes', 'suggest_fixes', 'suggestfixes',
      'generar_correcciones', 'generarcorrecciones', 'correciones_automaticas', 'correcciones'
    ],
    description: {
  ...
  'apply_auto_fixes': {
    ...
    aliases: [
      'apply_auto_fixes', 'apply_fixes', 'applyautofixes', 'fix',
      'aplicar_correcciones', 'aplicarcorrecciones', 'corregir', 'arreglar'
    ],
    description: {
  ...
  'generate_tests': {
    ...
    aliases: [
      'generate_tests', 'generatetests', 'create_tests', 'createtests', 'write_tests', 'writetests',
      'generar_pruebas', 'generarpruebas', 'crear_pruebas', 'crearpruebas', 'escribir_pruebas',
      'generar_tests', 'crear_tests'
    ],
    description: {
  ...
  'write_test_file': {
    ...
    aliases: [
      'write_test_file', 'writetestfile', 'save_tests', 'savetests',
      'escribir_archivo_prueba', 'escribirarchivoprueba', 'guardar_pruebas', 'guardarpruebas'
    ],
    description: {
  ...
  'analyze_architecture': {
    ...
    aliases: [
      'analyze_architecture', 'analyzearchitecture', 'analyze_project', 'analyzeproject',
      'analizar_arquitectura', 'analizararquitectura', 'analizar_proyecto', 'analizarproyecto'
    ],
    description: {
  ...
  'find_circular_deps': {
    ...
    aliases: [
      'find_circular_deps', 'findcirculardeps', 'circular_dependencies', 'circulardependencies',
      'encontrar_dependencias_circulares', 'dependencias_circulares', 'buscar_ciclos'
    ],
    description: {
  ...
  'scan_file': {
    canonical: 'scan_file',
    aliases: [
      'scan_file', 'scanfile', 'security_scan', 'securityscan', 'check_security', 'checksecurity',
      'escanear_archivo', 'escaneararchivo', 'escanear_seguridad', 'escanearseguridad',
      'verificar_seguridad', 'verificarseguridad'
    ],
    description: {
  ...
  'scan_project': {
    ...
    aliases: [
      'scan_project', 'scanproject', 'security_audit', 'securityaudit',
      'escanear_proyecto', 'escanearproyecto', 'auditoria_seguridad', 'auditoriaseguridad'
    ],
    description: {
  ...
  'extract_function': {
    ...
    aliases: [
      'extract_function', 'extractfunction', 'extract',
      'extraer_funcion', 'extraerfuncion', 'extraer'
    ],
    description: {
  ...
  'simplify_conditionals': {
    ...
    aliases: [
      'simplify_conditionals', 'simplifyconditionals', 'simplify',
      'simplificar_condicionales', 'simplificarcondicionales', 'simplificar'
    ],
    description: {
  ...
  'rename_variable': {
    ...
    aliases: [
      'rename_variable', 'renamevariable', 'rename',
      'renombrar_variable', 'renombrarvariable', 'renombrar'
    ],
    description: {
  ...
  'generate_jsdoc': {
    ...
    aliases: [
      'generate_jsdoc', 'generatejsdoc', 'jsdoc', 'document',
      'generar_jsdoc', 'generarjsdoc', 'documentar'
    ],
    description: {
  ...
  'generate_readme': {
    ...
    aliases: [
      'generate_readme', 'generatereadme', 'readme', 'create_readme',
      'generar_readme', 'generarreadme', 'crear_readme'
    ],
    description: {
  ...
  'generate_openapi': {
    ...
    aliases: [
      'generate_openapi', 'generateopenapi', 'openapi',
      'generar_openapi', 'generaropenapi'
    ],
    description: {
  ...
  'design_rest_api': {
    ...
    aliases: [
      'design_rest_api', 'designrestapi', 'rest_api', 'restapi',
      'disenar_api_rest', 'disenarapirest', 'api_rest', 'apirest'
    ],
    description: {
  ...
  'design_schema': {
    ...
    aliases: [
      'design_schema', 'designschema', 'create_schema', 'createschema',
      'disenar_esquema', 'disenaresquema', 'crear_esquema', 'crearesquema'
    ],
    description: {
  ...
  'generate_migration': {
    ...
    aliases: [
      'generate_migration', 'generatemigration', 'migration', 'create_migration',
      'generar_migracion', 'generarmigracion', 'migracion', 'crear_migracion'
    ],
    description: {
  ...
  '__health': {
    canonical: '__health',
    aliases: [
      '__health', 'health', 'health_check', 'healthcheck', 'status', 'diagnostics',
      'salud', 'estado', 'diagnosticos', 'verificar_estado'
    ],
    description: {
 ...
 */
export function matchToolName(input: string): string | null {
 ...
 */
export function getToolAliases(canonical: string): string[] {
 ...
 */
export function getToolDescription(canonical: string, language: 'en' | 'es'): string {
