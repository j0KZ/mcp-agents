 ...
 */
export function getTextAuto(text: BilingualText, context?: string): string {
 ...
 */
export function getClarificationOptions(language: Language) {
 ...
 */
export function getClarificationMessage(language: Language) {
  return {
 ...
 */
export function getInvalidFocusMessage(invalidFocus: string, language: Language) {
