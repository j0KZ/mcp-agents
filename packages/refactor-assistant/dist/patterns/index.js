 ...
 */
export function applySingletonPattern(code, _options) {
...
export function applyFactoryPattern(code, options) {
...
export function applyObserverPattern(code, _options) {
...
export function applyStrategyPattern(code, _options) {
...
export function applyDecoratorPattern(code, _options) {
...
export function applyAdapterPattern(code, _options) {
...
export function applyFacadePattern(code, _options) {
...
export function applyProxyPattern(code, _options) {
...
export function applyCommandPattern(code, _options) {
...
export function applyChainOfResponsibilityPattern(code, _options) {
