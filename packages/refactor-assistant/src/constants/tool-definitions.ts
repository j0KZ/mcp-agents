...
export const EXTRACT_FUNCTION_EXAMPLES: ToolExample[] = [
  {
...
export const CONVERT_TO_ASYNC_EXAMPLES: ToolExample[] = [
  {
...
export const SIMPLIFY_CONDITIONALS_EXAMPLES: ToolExample[] = [
  {
...
export const REMOVE_DEAD_CODE_EXAMPLES: ToolExample[] = [
  {
...
export const APPLY_PATTERN_EXAMPLES: ToolExample[] = [
  {
...
export const RENAME_VARIABLE_EXAMPLES: ToolExample[] = [
  {
...
export const SUGGEST_REFACTORINGS_EXAMPLES: ToolExample[] = [
  {
...
export const CALCULATE_METRICS_EXAMPLES: ToolExample[] = [
  {
...
Use when: reducing function size, improving reusability, DRY principle.`,
    inputSchema: {
      ...
      properties: {
        ...
        functionName: { type: 'string' as const, description: 'Name for the extracted function' },
        startLine: {
        ...
        arrow: { type: 'boolean' as const, description: 'Whether to use arrow function syntax' },
...
Use when: updating legacy code, improving readability, promise conversion.`,
    inputSchema: {
      type: 'object' as const,
      properties: {
        code: { type: 'string' as const, description: 'Source code with callbacks to convert' },
        useTryCatch: {
          type: 'boolean' as const,
...
Use when: reducing nesting, improving readability, early returns.`,
    inputSchema: {
      type: 'object' as const,
      properties: {
        code: { type: 'string' as const, description: 'Source code with conditionals to simplify' },
        useGuardClauses: {
          type: 'boolean' as const,
...
Use when: cleaning up codebase, reducing bundle size, maintenance.`,
    inputSchema: {
      type: 'object' as const,
      properties: {
        code: { type: 'string' as const, description: 'Source code to analyze and clean' },
        removeUnusedImports: {
          type: 'boolean' as const,
...
Use when: improving code structure, applying OOP principles, scalability.`,
    inputSchema: {
      ...
      properties: {
        ...
        patternOptions: { type: 'object' as const, description: 'Pattern-specific options' },
        response_format: RESPONSE_FORMAT_SCHEMA,
      },
...
Use when: improving naming, fixing typos, clarifying intent.`,
    inputSchema: {
      type: 'object' as const,
      properties: {
        code: { type: 'string' as const, description: 'Source code containing the variable' },
        oldName: { type: 'string' as const, description: 'Current variable name' },
        newName: {
          type: 'string' as const,
...
Use when: code review, improving quality, learning opportunities.`,
    inputSchema: {
      type: 'object' as const,
      properties: {
        code: { type: 'string' as const, description: 'Source code to analyze' },
        filePath: { type: 'string' as const, description: 'Optional file path for context' },
        response_format: RESPONSE_FORMAT_SCHEMA,
      },
      required: ['code'],
    },
