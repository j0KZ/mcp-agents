...
describe('MCP Server Integration', () => {
  describe('Tool Definitions', () => {
    ...
    it('should define apply_pattern tool with all 10 design patterns', async () => {
      ...
      const patternEnum = (tool?.inputSchema.properties.pattern as any).enum;
  ...
  describe('Boolean Default Values', () => {
    it('should have correct defaults for extract_function', async () => {
      ...
      expect((tool?.inputSchema.properties.async as any).default).toBe(false);
      expect((tool?.inputSchema.properties.arrow as any).default).toBe(false);
    });
    ...
    it('should have correct defaults for convert_to_async', async () => {
      ...
      expect((tool?.inputSchema.properties.useTryCatch as any).default).toBe(true);
    });
    ...
    it('should have correct defaults for simplify_conditionals', async () => {
      ...
      expect((tool?.inputSchema.properties.useGuardClauses as any).default).toBe(true);
      expect((tool?.inputSchema.properties.useTernary as any).default).toBe(true);
    });
    ...
    it('should have correct defaults for remove_dead_code', async () => {
      ...
      expect((tool?.inputSchema.properties.removeUnusedImports as any).default).toBe(true);
      expect((tool?.inputSchema.properties.removeUnreachable as any).default).toBe(true);
    });
    ...
    it('should have correct defaults for rename_variable', async () => {
      ...
      expect((tool?.inputSchema.properties.includeComments as any).default).toBe(false);
    });
  });
  ...
  describe('Parameter Types', () => {
    it('should use number type for line numbers', async () => {
      ...
      expect((tool?.inputSchema.properties.startLine as any).type).toBe('number');
      expect((tool?.inputSchema.properties.endLine as any).type).toBe('number');
    });
    ...
    it('should use boolean type for flags', async () => {
      ...
      expect((extractTool?.inputSchema.properties.async as any).type).toBe('boolean');
      expect((extractTool?.inputSchema.properties.arrow as any).type).toBe('boolean');
    });
    ...
    it('should use string type for code and names', async () => {
      ...
      expect((renameTool?.inputSchema.properties.code as any).type).toBe('string');
      expect((renameTool?.inputSchema.properties.oldName as any).type).toBe('string');
      expect((renameTool?.inputSchema.properties.newName as any).type).toBe('string');
    });
    ...
    it('should use object type for patternOptions', async () => {
      ...
      expect((tool?.inputSchema.properties.patternOptions as any).type).toBe('object');
    });
  });
  ...
  describe('Parameter Descriptions', () => {
    it('should describe line number format', async () => {
      ...
      const startDesc = (tool?.inputSchema.properties.startLine as any).description;
      const endDesc = (tool?.inputSchema.properties.endLine as any).description;
    ...
    it('should describe rename_variable validation', async () => {
      ...
      const newNameDesc = (tool?.inputSchema.properties.newName as any).description;
