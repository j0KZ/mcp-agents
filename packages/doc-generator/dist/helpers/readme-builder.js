 ...
 */
export function buildTitleSection(projectName, packageJson, config) {
    const sections = [];
 ...
 */
export function buildBadgesSection(packageJson, config) {
    const sections = [];
 ...
 */
export function buildTOCSection(config) {
    const sections = [];
 ...
 */
export function buildInstallationSection(packageJson, config) {
    const sections = [];
 ...
 * Build usage section
 */
export function buildUsageSection(packageJson, config) {
    const sections = [];
 ...
 * Build API section
 */
export function buildAPISection(config) {
    const sections = [];
    if (!config.includeAPI) {
        return sections;
    }
 ...
 */
export function buildContributingSection(config) {
    const sections = [];
    if (!config.includeContributing) {
        return sections;
    }
 ...
 */
export function buildLicenseSection(packageJson, config) {
    const sections = [];
...
//# sourceMappingURL=readme-builder.js.map