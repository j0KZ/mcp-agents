...
export const GENERATE_JSDOC_EXAMPLES = [
    {
...
export const GENERATE_README_EXAMPLES = [
    {
...
export const GENERATE_API_DOCS_EXAMPLES = [
    {
...
export const GENERATE_CHANGELOG_EXAMPLES = [
    {
...
export const GENERATE_FULL_DOCS_EXAMPLES = [
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                config: {
                    type: 'object',
                    properties: {
                        style: { type: 'string', enum: ['standard', 'google', 'typescript'] },
                        addTodoTags: { type: 'boolean' },
            ...
            properties: {
                ...
                config: {
                    ...
                    properties: {
                        ...
                        version: { type: 'string' },
                        includeInstallation: { type: 'boolean' },
                        includeUsage: { type: 'boolean' },
                        includeAPI: { type: 'boolean' },
            ...
            properties: {
                ...
                config: {
                    ...
                    properties: {
                        ...
                        includeInterfaces: { type: 'boolean' },
                        sortAlphabetically: { type: 'boolean' },
                        includeTOC: { type: 'boolean' },
