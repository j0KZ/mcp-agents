 ...
 */
export function generateUniversalConfig(selections: WizardSelections): any {
  const config: any = {
    mcpServers: {},
  };
 ...
 */
export function generateIDESpecificConfig(
  selections: WizardSelections,
  ide: 'claude' | 'cursor' | 'windsurf' | 'qoder' | 'vscode' | 'roo'
): any {
