...
export class ContextDetector {
     ...
     * Detect test runner
     */
    async detectTestRunner(context) {
        try {
            const packageJson = await this.readPackageJson();
            const deps = {
                ...packageJson.dependencies,
     ...
     */
    async detectVersionControl(context) {
        try {
     ...
     */
    async detectContainerization(context) {
        try {
     ...
     */
    async detectProjectStructure(context) {
        try {
     ...
     * Detect build tools
     */
    async detectBuildTools(context) {
        const buildTools = [
