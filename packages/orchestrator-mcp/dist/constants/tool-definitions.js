...
export const RUN_WORKFLOW_EXAMPLES = [
    {
...
export const RUN_SEQUENCE_EXAMPLES = [
    {
...
export const LIST_WORKFLOWS_EXAMPLES = [
    {
...
export const SEARCH_TOOLS_EXAMPLES = [
    {
...
export const LOAD_TOOL_EXAMPLES = [
    {
...
export const LIST_CAPABILITIES_EXAMPLES = [
    {
                ...
                steps: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            mcp: { type: 'string', description: 'MCP to invoke (e.g., smart-reviewer)' },
                            tool: { type: 'string', description: 'Tool to call (e.g., review_file)' },
