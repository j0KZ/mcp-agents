...
export function validateSQLSchema(schema, errors, warnings) {
...
export function validateMongoSchema(schema, _errors, warnings) {
...
export function estimateNormalForm(schema) {
