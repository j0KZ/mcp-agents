 ...
 */
export function detectRepeatingGroups(table) {
    const suggestions = [];
 ...
 */
export function detectPartialDependencies(table) {
    const suggestions = [];
 ...
 */
export function detectTransitiveDependencies(table) {
    const suggestions = [];
 ...
 */
export function detectRedundantData(table) {
    const suggestions = [];
 ...
 */
export function detectMissingJunctionTables(relationships) {
    const suggestions = [];
