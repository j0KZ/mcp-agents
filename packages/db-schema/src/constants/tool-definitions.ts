...
export const DESIGN_SCHEMA_EXAMPLES: ToolExample[] = [
  {
    name: 'Design e-commerce schema',
    description: 'Create database schema from requirements',
    input: {
      requirements:
        'Users have many orders. Orders contain products. Products belong to categories. Track order status and shipping.',
      options: {
        database: 'postgres',
        normalForm: '3NF',
...
export const GENERATE_MIGRATION_EXAMPLES: ToolExample[] = [
  {
...
export const CREATE_ER_DIAGRAM_EXAMPLES: ToolExample[] = [
  {
...
export const OPTIMIZE_INDEXES_EXAMPLES: ToolExample[] = [
  {
...
export const NORMALIZE_SCHEMA_EXAMPLES: ToolExample[] = [
  {
...
export const GENERATE_SEED_DATA_EXAMPLES: ToolExample[] = [
  {
...
export const VALIDATE_SCHEMA_EXAMPLES: ToolExample[] = [
  {
...
export const ANALYZE_SCHEMA_EXAMPLES: ToolExample[] = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        options: {
          type: 'object' as const,
          properties: {
            database: { type: 'string' as const, enum: ['postgres', 'mysql', 'mongodb'] },
            normalForm: { type: 'string' as const, enum: ['1NF', '2NF', '3NF', 'BCNF'] },
            includeTimestamps: { type: 'boolean' as const },
            useUUIDs: { type: 'boolean' as const },
          },
          required: ['database'],
        },
...
Use when: applying schema changes, version control for database.`,
    inputSchema: {
      type: 'object' as const,
      properties: {
        schema: { type: 'object' as const, description: 'Complete database schema object' },
        description: { type: 'string' as const, description: 'Migration description' },
        response_format: RESPONSE_FORMAT_SCHEMA,
      },
    ...
    inputSchema: {
      ...
      properties: {
        ...
        options: {
          type: 'object' as const,
          properties: {
            format: { type: 'string' as const, enum: ['mermaid', 'plantuml', 'dbml'] },
            includeColumns: { type: 'boolean' as const },
            includeRelationships: { type: 'boolean' as const },
          },
        },
        response_format: RESPONSE_FORMAT_SCHEMA,
      },
