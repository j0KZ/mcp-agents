...
function addCustomEndpoints(spec: OpenAPISpec, endpoints: RESTEndpoint[]): void {
...
function generateResourceEndpoints(spec: OpenAPISpec, config: APIDesignConfig): void {
